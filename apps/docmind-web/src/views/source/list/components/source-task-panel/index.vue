...
import { AppIcon, DocumentTaskProgress, type DocumentTaskStep } from '@/components/index.js';

import { formatSourceDate, getSourceVersionLabel } from '../../model/source-list.js';

defineOptions({ name: 'SourceTaskPanel' });
...
const taskSteps: DocumentTaskStep[] = [
  { id: 'registered', label: '原件登记' },
  { id: 'schema', label: '字段配置' },
  { id: 'review', label: '抽取复核' },
  { id: 'done', label: '完成' },
];
</script>
