...
@Entity
@Table(
    name = "sensitive_rule_template",
    uniqueConstraints =
        @UniqueConstraint(
            name = "uq_sensitive_rule_template_creation_key",
            columnNames = {"workspace_id", "created_by", "creation_idempotency_key"}))
public class SensitiveRuleTemplate {
  ...
  protected SensitiveRuleTemplate() {}

  public SensitiveRuleTemplate(
      UUID workspaceId,
      String name,
      String description,
      UUID createdBy,
