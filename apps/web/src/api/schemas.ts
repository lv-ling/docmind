...
export interface ExtractionSchemaDetail {
  ...
  current_version: import('@docmind/contracts').SchemaVersion | null;
  versions: import('@docmind/contracts').SchemaVersion[];
}

export interface SensitiveRuleTemplateDetail {
  template: SensitiveRuleTemplate;
  current_version: import('@docmind/contracts').SensitiveRuleTemplateVersion | null;
  versions: import('@docmind/contracts').SensitiveRuleTemplateVersion[];
}
